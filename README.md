...
### Experimental: for using Coding Agents: there is an [instructions file](AGENTS.MD) which seems to capture a lot af the standarts outs of the box and which I have shamelessly copied over from [Max Woolf](https://gist.github.com/minimaxir/10b780671ee5d695b4369b987413b38f)
